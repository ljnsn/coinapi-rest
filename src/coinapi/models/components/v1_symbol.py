...
class V1Symbol(msgspec.Struct, kw_only=True, frozen=True, omit_defaults=True):
    ...
    future_delivery_time: datetime | None = msgspec.field(default=msgspec.UNSET)
    r"""The future delivery time for futures contract."""
    option_type_is_call: bool | None = msgspec.field(default=msgspec.UNSET)
    ...
    option_expiration_time: datetime | None = msgspec.field(default=msgspec.UNSET)
    r"""The expiration time for options."""
    contract_delivery_time: datetime | None = msgspec.field(default=msgspec.UNSET)
    ...
    data_quote_start: datetime | None = msgspec.field(default=msgspec.UNSET)
    r"""The start date of quote data."""
    data_quote_end: datetime | None = msgspec.field(default=msgspec.UNSET)
    r"""The end date of quote data."""
    data_orderbook_start: datetime | None = msgspec.field(default=msgspec.UNSET)
    r"""The start date of order book data."""
    data_orderbook_end: datetime | None = msgspec.field(default=msgspec.UNSET)
    r"""The end date of order book data."""
    data_trade_start: datetime | None = msgspec.field(default=msgspec.UNSET)
    r"""The start date of trade data."""
    data_trade_end: datetime | None = msgspec.field(default=msgspec.UNSET)
